...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha512-6G/KX6g9VOKL5M5No5NGxsKjyW00u6f/1+lhyykKvjgih5os9G7N5HIt25p+7gjK6+u8Mk+0wbzS1OvZmWz9jw==" crossorigin="anonymous" />
    ...
    <div class="container">
      ...
      <div class="row align-items-center mt-2">
        ...
        <div class="col-auto">
          ...
          @auth
            @if(auth()->check() && auth()->user()->favoriteBuildings->contains($building->id))
              <button class="btn btn-light mt-2 add-building-to-favorites"  data-building-id="{{ $building->id }}" style="border: 1px solid black; padding: 6px 12px; font-size: 16px;">
        ...
        <div class="row">
          ...
          <div class="slider" style="margin-top: 3%;">
            ...
            <div class="slide @if($loop->first) active @endif">
                <img src="{{ asset('storage/building_images/' . $image->path) }}" alt="{{ $image->name }}" width="100%" height="100%" loading="lazy" class="slider-img">
            </div>
            @endforeach
            @if($images->count()>1)
          ...
          <div class="col-md-4">
            <div class="house-type" style="font-size: 36px; color: #777; margin-bottom: 30px; font-weight: bold; font-style:inherit;">
              ...
              <div class="price " style="color: #7dbad8; margin-top: 20px;" >
                <h2 >{{ $building->prix }} DH @if($building->type_annonce=='Location') /mois @endif</h2>
              </div>
            </div>
          </div>
