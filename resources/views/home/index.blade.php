            ...
            <ul class="list-group">
                @foreach($messages as $message)
                    <li class="list-group-item">
                        <strong>{{ $message->client_name }} :</strong> {{ $message->message }}
                    </li>
                @endforeach
            </ul>
        @else
            <p>Aucun message reçu pour cette propriété.</p>
        @endif
    @else
        <p>Aucun message reçu pour cette propriété.</p>
    @endif
...
.dropdown-menu a:hover{
  color:white;
    ...
    <div class="col-div-3">
      <div class="box">
        <p> <?php
              $houseCount = \Illuminate\Support\Facades\DB::table('houses')->count();
              $landCount = \Illuminate\Support\Facades\DB::table('land')->count();
              $buildingCount=\Illuminate\Support\Facades\DB::table('buildings')->count();
              $sommeCount=$houseCount + $landCount+$buildingCount;
            echo $sommeCount;
            ?><br/><span>Propriétés</span></p>
