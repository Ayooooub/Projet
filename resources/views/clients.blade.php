...
.btn:hover{
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <a href="/clients" id="clients" class="icon-a" ><i class="fas fa-users icons"></i> Clients</a>
  ...
  <a class="nav-link" href="{{ route('logout.perform') }}"><i class="fas fa-sign-out-alt"></i> Deconnexion</a>
	...
	<div id="main">
		...
		<div class="head">
			<div class="col-div-6">
	<span style="font-size:30px;cursor:pointer; color: #91a6b4;" class="nav" >☰ Clients</span>
	<span style="font-size:30px;cursor:pointer; color: #91a6b4;" class="nav2">☰ Clients</span>
	</div>
    ...
    <div class="content-box">
        <p>Clients<a href="/users"><span> Voir tout</span></a></p>
        <br>
        <table>
            @foreach($clients as $client)
                ...
                <tr>
                    ...
                    <td>{{ $client->numtel }}</td>
                    <td>
                        <form action="/clients/{{ $client->id }}" method="POST" onsubmit="return confirm('Êtes-vous sûr(e) de vouloir supprimer cet utilisateur ?')">
                            @csrf
                            @method('DELETE')
