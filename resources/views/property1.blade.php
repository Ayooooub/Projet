...
.card h1 {
	...
	<div id="main">
		...
		<div class="head">
			<div class="col-div-6">
	<span style="font-size:30px;cursor:pointer; color:#91a6b4;" class="nav" >☰ liste des propriétés</span>
	<span style="font-size:30px;cursor:pointer; color: #91a6b4;" class="nav2">☰ liste des propriétés</span>
	</div>
